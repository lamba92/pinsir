...
class GatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.elaborate = channel.unary_unary(
                ...
                response_deserializer=gateway__pb2.GatewayResponse.FromString,
                )
...
def add_GatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'elaborate': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=gateway__pb2.GatewayResponse.SerializeToString,
            ),
    }
...
class Gateway(object):
    ...
    def elaborate(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Gateway/elaborate',
            ...
            gateway__pb2.GatewayResponse.FromString,
